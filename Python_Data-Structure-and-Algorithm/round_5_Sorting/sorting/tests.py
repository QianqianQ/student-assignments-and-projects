...
class TestMySort(unittest.TestCase):
    ...
    def test3_10_already_sorted(self):
        ...
        self._test_sort(list(range(1000000)))
    ...
    def test4_10_unique(self):
        ...
        self._test_sort(random.sample(range(10), 10))
    ...
    def test8_100_unique(self):
        ...
        self._test_sort(random.sample(range(100), 100))
    ...
    def test9_100_with_duplicates(self):
        ...
        self._test_sort([random.randint(0,9) for _ in range(100)])
